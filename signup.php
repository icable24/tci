					...
					<div class="panel panel-info centered">
                    	...
                    	<form action="php/check_login.php" method="post">
                            ...
                            <div class="form-group input-group">
                                ...
                                <input class="form-control" type="text" required="" id="email" name="email" placeholder="Firstname"/>
                            </div>
                            <label class="control-label" for="email">Lastname:</label>
                            <div class="form-group input-group">
                                <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                                <input class="form-control" type="text" required="" id="email" name="email" placeholder="Lastname"/>
                            </div>
