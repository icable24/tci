...
EOD;
    ...
    echo $edate;
      ...
      $sql = "SELECT *  FROM orders JOIN account ON orders.acc_id = account.acc_id WHERE date_finished between '$sdate' and '$edate' AND order_finish = 'Completed' AND user_type = 'Single Buyer'"; 
...
EOD;
    ...
    $connect = mysqli_connect("localhost", "root", "", "tcishop");  
      ...
      $sql = "SELECT *  FROM orders JOIN account ON orders.acc_id = account.acc_id WHERE order_finish = 'Completed' AND user_type = 'Single Buyer'"; 
...
EOD;
    ...
    echo $edate;
      ...
      $sql = "SELECT *  FROM orders JOIN account ON orders.acc_id = account.acc_id WHERE date_finished between '$sdate' and '$edate' AND order_finish = 'Completed' AND user_type = 'Company'"; 
...
EOD;
    ...
    $connect = mysqli_connect("localhost", "root", "", "tcishop");  
      ...
      $sql = "SELECT *  FROM orders JOIN account ON orders.acc_id = account.acc_id WHERE order_finish = 'Completed' AND user_type = 'Company'"; 
