...
EOD;
    ...
    echo $edate;
      ...
      $sql = "SELECT order_id, acc_fname, acc_lname, shippingaddress, order_amount, date_ordered, date_finished  FROM orders JOIN account ON orders.acc_id = account.acc_id WHERE date_ordered between '$sdate' and '$edate' AND order_finish = 'Completed'"; 
      ...
      $result = mysqli_query($connect, $sql);  
        ...
        $tbl = $tbl . '
            ...
            <tr>
                ...
                <td style="border: 1px solid #000000; width: 140px;">'.$date_finished.'</td>
