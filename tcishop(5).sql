...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 04, 2018 at 06:33 AM
...
INSERT INTO `cart` (`cart_id`, `user_id`, `order_id`, `prod_id`, `quantity`) VALUES
(1, 2, 0, 47, 6),
(2, 2, 0, 26, 1);
...
INSERT INTO `orders` (`order_id`, `acc_id`, `name`, `acc_company`, `shippingaddress`, `country`, `state`, `city`, `acc_email`, `acc_contact`, `zip_code`, `order_amount`) VALUES
(1, 0, 'Jayson Solinap', 'L\'Fishers', 'bacolod', 'Brunei', 'negros occidental', 'city', 'jayson@tci.com', '09234567890', 145, 0);
